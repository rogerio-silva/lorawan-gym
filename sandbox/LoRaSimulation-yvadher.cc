 ...
 for (int i =0 ; i< 10; i++)
   {
     ...
     cmd.AddValue ("sideLength",
                   "The sideLength of the area to simulate", sideLength);
...
//     BuildingsHelper::MakeMobilityModelConsistent ();
     ...
     if (print)
       {
         helper.DoPrintDeviceStatus(endDevices, gateways,
                                 "endDevices.dat");
       }
     ...
     helper.DoPrintGlobalPerformance("globalPerformance.txt");
   }
